package com.leimingtech.extend.module.payment.module.whchat.mobile.refund.service.impl;
...
import com.leimingtech.extend.module.payment.wechat.mobile.ClientCustomSSL;
import com.leimingtech.extend.module.payment.wechat.mobile.config.WachatMobileContent;


@Slf4j
@Service
public class WechatMobileRefundServiceImpl implements WechatMobileRefundService{@Override
	public Map<String, Object> toRefund(WeiRefund weirefund) {
			...
			String appid = WachatMobileContent.appid; //微信公众号apid
			String appsecret = WachatMobileContent.appsecret; //应用密钥
			String mch_id = WachatMobileContent.mchid;  //微信商户id
			String op_user_id =WachatMobileContent.mchid;//就是MCHID
			String apikey =WachatMobileContent.apikey;//商户平台上的那个KEY
